...
Later isolated injection-head experiments improved a new Turkish/English cross-source diagnostic but regressed on the original mixed-only synthetic test and flagged 80% of benign agent tool returns. They are **not** this released v2 model. See [experiment decision](reports/injection_experiments.md).
